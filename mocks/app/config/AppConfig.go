...
// GetConfigs provides a mock function for the type AppConfig
func (_mock *AppConfig) GetConfigs() *config.Config {
	ret := _mock.Called()
...
func (_c *AppConfig_GetConfigs_Call) Return(config1 *config.Config) *AppConfig_GetConfigs_Call {
...
// LoadConfigs provides a mock function for the type AppConfig
func (_mock *AppConfig) LoadConfigs() error {
	ret := _mock.Called()
...
func (_c *AppConfig_LoadConfigs_Call) Return(err error) *AppConfig_LoadConfigs_Call {
	_c.Call.Return(err)
	return _c
}
